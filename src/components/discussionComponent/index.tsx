...
import ReplyItem from "../replyComponent";
...
export default function DiscussionItem({
  ...
  return (
    <div className="flex flex-col justify-start mb-3 bg-light-primary rounded-lg p-5">
      <div className="grid grid-cols-12 flex-row">
        ...
        <div className="col-start-5 col-span-8">
          <div className="flex justify-between">
            ...
            >
              <a className="text-white text-2xl">{data.title}</a>
            </Link>
          ...
          <p className="text-gray-400 mb-4">{data.content.substring(0, 100)}</p>
          {
            <a
