...
const styles = require("./article.module.scss");
import Link from "next/link";

export default function ArticlePage() {
  return (
    <div
      className={`w-11/12 mx-auto bg-dark-primary overflow-y-scroll rounded-lg mt-10 ${styles.container}`}
    >
          ...
          {articleData.map((data, idx) => (
            <div className="m-3" key={idx}>
              <div className="flex items-center">
                ...
                <div className="ml-3 text-gray-500 text-md">
                  <Link
                    href={{
                  ...
                  >
                    <a className="text-white text-2xl">{data.name}</a>
                  </Link>
                </div>
              </div>
        ...
        <div className="border-gray-400 border-l col-span-2 col-start-9 p-2">
          <div>
            ...
            <div>
              ...
              <h5 className="text-gray-500 text-md mx-2 mb-5">Oct 28. 4min read</h5>
            </div>
            <div>
              <h2 className="text-white text-md mx-2 mb-5">
                The Founder's Guide to Actually,
