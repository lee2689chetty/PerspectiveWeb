...
const styles = require("./articleview.module.scss");
...
export default function ArticleViewPage() {
  ...
  return (
    <div className="grid grid-cols-12 bg-dark-primary m-4 w-full ">
      <div
        className={`col-start-1 col-span-9 p-5 flex flex-col ${styles.container} overflow-y-scroll`}
      >
        ...
        <div className="h-m w-full bg-gray-600 p-0.5 mt-4"></div>
      ...
      <div className="col-start-10 col-span-3 border-l-2 border-gray-600 flex flex-col pt-10 text-gray-600 p-2  overflow-y-scroll">
        <div>
          <h2 className="text-white text-md mx-2 mb-5">READ MORE ARTICLES ON THIS TOPIC</h2>
          <div>
          <h2 className="text-white text-md mx-2 mb-5">
          The Founder's Guide to Actually,
          </h2>
          <h5 className=" text-md mx-2 mb-5">Oct 28. 4min read</h5>
          </div>
          <div>
          <h2 className="text-white text-md mx-2 mb-5">
          The Founder's Guide to Actually,
...
ArticleViewPage.getLayout = function getLayout(ArticleViewPage: ReactElement) {
  return <Layout>{ArticleViewPage}</Layout>;
};
