...
export function Navbar() {
  ...
  return (
    <>
      <nav className={`items-center flex-wrap p-3 absolute w-full bottom-0`}>
        <Link href="/">
          <div className="inline-flex items-center px-10 w-full">
            ...
            <img
              ...
              width={50}
              height={50}
              className="top-0 hidden xl:flex m-auto"
            />
            <h5 className="text-white text-mm">PERSPECTIVE</h5>
            </div>
            ...
            <h3 className="text-mm text-white">@2021 Perspective, inc.</h3>
          </div>
        </Link>
      </nav>
    </>
